  ...
  return (
    <section id="skills">
      ...
      <span className="skillDescr">
        I'm a passionate and versatile software engineer with expertise in Web Development, 
        Flutter, React Native, and Javascript (Node, Express). My journey in the world of
        programming began with a curiosity-driven exploration of website
        development, and it has since evolved into a thrilling adventure
        encompassing the realms of mobile app development.
      </span>
